...
public class Tb_Bank_Card_Info {
	private Integer id;
	...
	private Integer bank_card_type;//银行卡类型，默认为储蓄卡
	private Integer bank_account_type;//银行卡账户类型：默认为
	...
	public Integer getBank_account_type() {
		return bank_account_type;
	}
	public void setBank_account_type(Integer bank_account_type) {
