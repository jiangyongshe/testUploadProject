...
public interface Constant {
	 ...
	 * 用户状态-禁用
	 */
	int USER_STATUS_FORBIDDEN = 1;
	
	/**
	 * 用户状态-启用
	 */
	int USER_STATUS_ENABLE = 2;
	...
	String SESSION_USER_ACCOUNTID = "SESSION_ACCOUNTID";
	...
	String FORGET_WITHDRAW_PWD = "forgetWithDrawPwd";
	 ...
	 * 验证码有效时间，2分钟
	 */
	int VERIFICATION_VALID_TIME = 120;
	 ...
	 * 业务员出金是否受限key
	 */
	String SYSTEM_KEY_SALEMAN_WITHDRAW_LIMIT = "salesman_withdraw_limit";
	
	/**
	 * 运营中心出金是否受限key
	 */
	String SYSTEM_KEY_OPERATIONCENTER_WITHDRAW_LIMIT = "operation_center_withdraw_limit";
	 ...
	 * 业务员出金审核阈值key
	 */
	String SYSTEM_KEY_SALEMAN_WITHDRAW_THRESHOLD = "salesman_withdraw_threshold";
	
	/**
	 * 运营中心出金审核阈值key
	 */
	String SYSTEM_KEY_OPERATERCENTER_WITHDRAW_THRESHOLD = "operation_center_withdraw_threshold";
	 ...
	 * 标准格式 -> 年-月-日 时:分:秒
	 */
	SimpleDateFormat NORMAL_YMDHMS = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	 ...
	 * 钱包充值-银联-异步返回URL
	 */
	String UNION_RECHARGE_NOTIFY_UTL="chinese/exclude/walletRechargePay/unPayNotify.do";
	
	/**
	 * 订单支付-银联-异步返回URL
	 */
	String UNION_ORDERPAY_NOTIFY_UTL="chinese/exclude/orderPay/unPayNotify.do";
	 ...
	 * loginAppId
	 */
	String LOGINAPPID = "wxcfca560da6abf615";
	
	/**
	 * 第三方登录使用
	 * loginAppId
	 */
	String LOGINAPPSECRET = "8f4fcbce7355c31999162a08e13b3424F";
