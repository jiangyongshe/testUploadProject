...
function loadADData(obj){
	...
	function(res){
		...
		if(data&&data.length>0){
			...
			// 添加页码HTML代码
			pageNumber(res.count,obj,loadADData,'ad');
		}
	},
	function(){});
}
