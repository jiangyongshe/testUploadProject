...
function register(){
	...
	jsonAjax("/"+language+"/user/registerUser.do",{mobile:mobile,validCode:validCode,passWord:passWord,passWord1:passWord1,inviteCode:inviteCode,registerType:1},function(res){
