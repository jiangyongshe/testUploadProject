...
MeScroll.prototype.extendUpScroll = function(optUp) {
	...
	MeScroll.extend(optUp, {
		...
		warpClass: "mescroll-upwarp hide", //上拉加载的布局容器样式,参见mescroll.css
		htmlLoading: '<p class="upwarp-progress mescroll-rotate"></p><p class="upwarp-tip" style="display:none">加载中..</p>', //上拉加载中的布局
		...
		inited: function(mescroll, upwarp) {
			...
			mescroll.upProgressDom = upwarp.getElementsByClassName("upwarp-progress")[0];
		},
...
MeScroll.prototype.initDownScroll = function() {
	...
	function touchendEvent(e) {
		/*var sc=$("#mescroll")[0];
		alert(sc.scrollHeight - sc.clientHeight-sc.scrollTop);*/
...
MeScroll.prototype.initUpScroll = function() {
	...
	//滚动监听
	me.scrollDom.addEventListener("scroll", function(ev) {
...
MeScroll.prototype.showNoMore = function() {
	this.upwarp.style.visibility = "hidden"; //显示上拉加载区域
