...
<!-- 逻辑处理 -->
<script src="/js/core/unionpay.js"></script>
</head>
<body>
	<!-- 公用头部JS-->
			...
			<div class="width clear quan pos-r">
				...
				<div class="right bg-ff">
					<div class="clear width bg-f3 wddd">
						<h2 class="fl font16 pad-t7 pad-b5">银联支付</h2>
					</div>
					<div class="ggtf-sc pad-t20 font14 clear">
						<ul>
							<li>
								<span class="pos-a ggtf-sc-bt">支付金额</span> 
								<input id="money" type="text" class="wenb03 disabled"/></li>
							<li>
