...
function showJudegTip(status,title,content,hideCloseBtn){
	...
	if(!tipEle){
		...
		tipDiv.innerHTML = 
		'<div class="tanchu tanchu2" style="height:auto;">'+
			'<div class="tanchu-bt">'+
...
function showEmplyDiv(str,obj){
	...
	if(emplyDiv){
		...
		emplyDiv.setAttribute('class','col-ccc text-c pad-t20 sea-fruit');
...
function showConfimTip(title,content,confirmFun){
	...
	if(!div){
		...
		confirmdiv.innerHTML=
		  '<div class="tanchu tanchu1" style="height:auto;width:auto; margin-top:-100px;">'+
		    ...
		    '<div class="tanchu-nr text-c">'+
		      '<p class="pad-t5" id="confirmContent">'+content+'</p>'+
		       '<div class="tanchu-xyan text-c" style=" padding-bottom:0px;position:relative;top:10px">'+
		           ...
		           '<input name="" type="button" onclick="turnoff(\'successdiv\')" value="取消" class="btn btn04 font14 mar-l10" />'+
		       '</div>'+
		    '</div>'+
		  '</div>';
