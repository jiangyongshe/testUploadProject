var chineseError=["绑定成功,正在前往首页...","信息填写不完整","手机号为空","手机号格式错误","两次输入密码不一致","密码为6-12个字符","邀请码不能超过10个字符","验证码为6个字符","注册合伙人成功,请等待审核！"];
...
function register(){
	...
	jsonAjax("/"+language+"/user/registerUser.do",{mobile:mobile,validCode:validCode,passWord:passWord,passWord1:passWord,registerType:1},function(res){
