   ...
   <!--右侧内容-->
    <div class="right bg-ff">
      <ul class="jindu font16">
        <li class="active">购买广告位<span class="pos-a">1</span></li>
        <li class="">上传广告投放资料<span class="pos-a">2</span></li>
      ...
      <div class="rmgg-table font13" id="dataList">
        <div class="pad-t10 pad-l10"><!-- <label class="checkbox"><input type="checkbox" name="checkbox" id="ckAll" checked ><i>✓</i> 全选</label> --></div>
      ...
      <div class="text-r pad-t30 clear ggtf-gm">
        <span class="dis-in font14">
        	...
        	<span class="totalBalDiv">
        		<span class="red font18 totalBal">0元</span>
        	</span>
        </span>
