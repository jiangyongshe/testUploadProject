...
public class Tb_customer_comm_report {
	...
	private String customer_name;// 真实姓名
	...
	private BigDecimal WALLET_DEPOSIT;// 补出
	private BigDecimal WALLET_WITHDRAW;// 入金 
	
	
	public BigDecimal getWALLET_DEPOSIT() {
		return WALLET_DEPOSIT;
	}
	public void setWALLET_DEPOSIT(BigDecimal wALLET_DEPOSIT) {
		WALLET_DEPOSIT = wALLET_DEPOSIT;
	}
	public BigDecimal getWALLET_WITHDRAW() {
		return WALLET_WITHDRAW;
	}
	public void setWALLET_WITHDRAW(BigDecimal wALLET_WITHDRAW) {
