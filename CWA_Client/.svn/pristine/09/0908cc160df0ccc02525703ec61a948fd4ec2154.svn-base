...
public class JedisUtil {
	...
	//Redis服务器IP
    private static String ADDR = GobalProperties.getGobalConfig().getValueByKey("redis.ip");
    
    //Redis的端口号
    private static int PORT = GobalProperties.getGobalConfig().getIntegerValueByKey("redis.port");
    
    //访问密码
    private static String AUTH = GobalProperties.getGobalConfig().getValueByKey("redis.pwd");
