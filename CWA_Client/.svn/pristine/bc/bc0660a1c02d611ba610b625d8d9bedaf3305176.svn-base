...
<body>
	<div class="clear width">
		<div class="mar-auto pos-r">
    		...
    		<div class="fr ding-r login-r font16 col-999"> 翔云播共享广告，人人广告，人人分享！ </div>
  		</div>
	</div>
		...
		<div class="mar-auto">
			<div class="regis02 bg-ff font14 pos-r">
				<div class="pos-a regis02-tit">
		        	<div class="dis-in font16">重置密码</div>
		        	<div class="fr font16">已有账号？ <a href="/<spring:message code="url.language"/>/exclude/forward/login.do" class="yellow">立即登录</a></div>
		       </div>
				...
				<div class="pos-r pad-t20">
					...
					<input type="text" id="verification" class="wenb02 bor" value="" placeholder="请输入手机验证码"/> 
					<input id="getVerification" class="btn btn02 bg-orange regis02-yzm pos-a" style="width: 8em;" type="button" value="获取验证码" />
				</div>

				<div class="pos-r pad-t20">
					<span class="pos-a regis02-mc">重置密码</span> 
					<input id="resetPwd" type="text" class="wenb02 bor" placeholder="6到12位字符，区分大小写" onfocus="this.type='password'"/>
				</div>

				<div class="pad-t10 text-c red tishi01" id="forgetPwdTip"></div>

				<div class="pad-t20">
					<input id="submit" type="button" value="提交" class="btn btn01 bg-orange font14 width" />
				</div>

				<div class="pos-a regis03 font18 text-c">
	        		<p>关注翔云播</p>
	        		<p class="pad-t15">获得更多信息</p>
