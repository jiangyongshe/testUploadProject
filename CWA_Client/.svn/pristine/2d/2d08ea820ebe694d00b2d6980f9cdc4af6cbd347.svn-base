...
public class UserService extends BaseController<GobalRespParameter> implements Constant{
	...
	public String queryLoginIdByAccountId(String accountId,String tType){
		return customerDao.queryLoginIdByAccountId(accountId,tType);
	}
	
	public void updateWPWD(String accountId,String pwd){
		customerDao.updateWPWD(accountId,pwd);
	}
	//查找用户未阅读的公告
	public List<NoticeDto> findLookNotice(Integer noticeId,String userType){
		return customerDao.findLookNotice(noticeId,userType);
	}
	//更新消息公告最大id
	public void uploadMaxNoticeId(Integer noticeId,String accountId){
		customerDao.uploadMaxNoticeId(noticeId,accountId);
	}
	...
	public CustomerDto queryCustomerByAccountId(String accountId){
		return customerDao.queryCustomerByAccountId(accountId);
	}
	/**
	 * 根据unionId查询用户
	 * @param accountId
	...
	public CustomerDto queryCustomerByUnionId(String unionId){
		return customerDao.queryCustomerByUnionId(unionId);
	}
}
