...
public enum RespCodeEnum {
	...
	bank_card_existCard("该用户已绑卡","70001"),
	pay_amount_error("70002","非法金额"),
	
	orderNo_empty_error("订单号为空","80001"),
	upload_fileType_error("上传文件类型错误","80002"),
	upload_orderNoPay_error("上传文件订单未支付","80003"),
	updImgCount_difference_error("上传图片数量和购买数量不一致","80004"),

	update_password_verificationValid("手机验证码有效","60001"),
	update_password_oldPasswordError("原密码错误","60002");
